Public Class BlockImageSide
    ...
    Public Sub New(pintLen As Integer, pintCellSize As Integer, pobjBaseColor As Color, pobjEdgeColor As Color, psngOpacity As Single, pbolIsEdgeView As Boolean)
        intLen = pintLen
        ...
        DrawBlockImage()
    End Sub
    Public Sub New(pintLen As Integer, pintCellSize As Integer, pobjColorSetting As BlockColor.ColorSetting, pbolIsEdgeView As Boolean)
        Me.New(pintLen, pintCellSize, pobjColorSetting.Base, pobjColorSetting.Edge, pobjColorSetting.Opacity, pbolIsEdgeView)
    End Sub
    Public Sub New()
        Me.New(1, 16, New BlockColor.ColorSetting(), True)
    End Sub
    ...
    Protected Overridable Sub DrawBlockImage()
        ...
        p = New Pen(DirectCast(IIf(bolIsEdgeView, objEdgeColor, objBaseColor), Color), 1)
